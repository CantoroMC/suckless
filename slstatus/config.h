...
static const struct arg args[] = {
	...
	{ mpd_stat,          "#66ff66", "#bbbbbb", " %s ",          NULL},
	{ ram_perc,          "#396bd7", "#f2f2f2", " \uf2db %s%% ", NULL},
	{ swap_perc,         "#396bd7", "#f2f2f2", "(%s%%)",        NULL},
	{ cpu_perc,          "#396bd7", "#f2f2f2", " \uf085 %s%% ", NULL},
	{ cpu_freq,          "#396bd7", "#f2f2f2", "(%sHz) ",       NULL},
	{ temp,              "#396bd7", "#f2f2f2", " \uf8c7 %s ",   "/sys/bus/platform/devices/coretemp.0/hwmon/hwmon4/temp1_input"},
	{ temp,              "#396bd7", "#f2f2f2", "%s ",           "/sys/bus/platform/devices/coretemp.0/hwmon/hwmon4/temp2_input"},
	{ temp,              "#396bd7", "#f2f2f2", "%s ",           "/sys/bus/platform/devices/coretemp.0/hwmon/hwmon4/temp3_input"},
	{ temp,              "#396bd7", "#f2f2f2", "%s ",           "/sys/bus/platform/devices/coretemp.0/hwmon/hwmon4/temp4_input"},
	{ temp,              "#396bd7", "#f2f2f2", "%s°C ",         "/sys/bus/platform/devices/coretemp.0/hwmon/hwmon4/temp5_input"},
