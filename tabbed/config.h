...
/* appearance */
static char font[]        = "Operator Mono Lig Book:pixelsize=10:antialias=true:autohint=true";
static char* normbgcolor  = "#151a1e";
static char* normfgcolor  = "#fafafa";
static char* selbgcolor   = "#151a1e";
static char* selfgcolor   = "#b8c552";
static char* urgbgcolor   = "#151a1e";
static char* urgfgcolor   = "#ff3333";
